...
__all__ = ['dair_parse_sgnet_args']

def dair_parse_sgnet_args():
    parser = parse_base_args()
    parser.add_argument('--dataset', default='DAIR', type=str)
    parser.add_argument('--lr', default=5e-04, type=float) # Social 0.0010 ETH 0.0005，HOTEL 0.0001, UNIV 0.0001, ZARA1 0.0001, ZARA2 0.0001
    parser.add_argument('--eth_root', default='data/DAIR', type=str)
    ...
    parser.add_argument('--ETH_CONFIG', default='./configs/dair/DAIR.json', type=str)

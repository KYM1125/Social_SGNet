...
class MyScene(object):
    def __init__(self, timesteps, map=None, dt=0.1, name="", frequency_multiplier=1, aug_func=None,  non_aug_scene=None):
        self.map = map
        ...
        print(f"Initialized Scene with timesteps: {self.timesteps}, dt: {self.dt}, duration: {self.duration()}s")
